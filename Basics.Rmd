...
# classIntervals uses a variety of segmentation or cluster methods to separate data into groups (e.g. for plotting); help(classIntervals)
...
legend("topleft", fill = attr(fj5col, "palette"), title = main, legend = names(attr(fj5col, "table")), bty = "n")
...
## The hyrbid sampler, this is a Gibbs sampler, except for the conditional rho sampler, for which a Metropolis Hastings algorithm is used 
...
```{r, echo=FALSE, fig.width=9, fig.height=7, fig.cap=" "}
